...
public class OXGameTest {
    ...
    @Test
    public void ผู้แล่นคนที่หนึ่งเริ่มต้นเล่นในตำแหน่ง0_0_ในตารางต้องมีค่าเป็นX() {
        OXGame game = new OXGame();
        Player player1 = new Player("X");
        game.playWith(player1, 0, 0);
        assertEquals("X", game.getTables()[0][0]);
    }

    @Test
    public void ผู้แล่นคนที่สองเล่นในตำแหน่ง1_0_ในตารางต้องมีค่าเป็นO() {
        OXGame game = new OXGame();
        Player player1 = new Player("X");
    ...
    public void เมื่อมีคนเล่นที่สองชนะ_ในแนวนอนแถวที่2() {
        ...
        game.playWith(player2, 1, 1);
        game.playWith(player1, 2, 2);
        game.playWith(player2, 1, 2);
        assertTrue(game.isWinner());;
    }

    @Test
    public void เมื่อมีคนเล่นที่หนึ่งชนะ_ในแนวนอนแถวที่3() {
        OXGame game = new OXGame();
        Player player1 = new Player("X");
        Player player2 = new Player("O");
        game.playWith(player1, 2, 0);
        game.playWith(player2, 1, 0);
        game.playWith(player1, 2, 1);
        game.playWith(player2, 1, 1);
        game.playWith(player1, 2, 2);
        assertTrue(game.isWinner());;
    }
    ...
    @Test
    public void เมื่อมีคนเล่นที่สองชนะ_ในแนวนอนแถวที่3() {
        OXGame game = new OXGame();
        Player player1 = new Player("X");
        Player player2 = new Player("O");
        game.playWith(player1, 1, 0);
        game.playWith(player2, 2, 0);
        game.playWith(player1, 1, 1);
        game.playWith(player2, 2, 1);
        game.playWith(player1, 0, 2);
        game.playWith(player2, 2, 2);
        assertTrue(game.isWinner());;
    }

    @Test
    public void เมื่อมีคนเล่นที่หนึ่งชนะ_ในแนวทแยง() {
        OXGame game = new OXGame();
        Player player1 = new Player("X");
        Player player2 = new Player("O");
        game.playWith(player1, 0, 0);
